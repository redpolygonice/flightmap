...
// Base device
class RoadDevice : public IDevice, public std::enable_shared_from_this<RoadDevice>
{
public:
...
public:
	RoadDevice(const comms::CommunicationPtr &comm) : _comm(comm), _telebox(nullptr), _mission(nullptr) {}
	virtual ~RoadDevice() {}
